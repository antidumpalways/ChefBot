    ...
    >
      {!isSearchOpen ? (
        <button
          ...
          className="flex items-center gap-3 text-base-content hover:text-primary transition-colors duration-200 px-4 py-3 rounded-lg border border-base-300 hover:border-primary bg-base-100 hover:bg-base-200 w-80"
        >
          <SearchIcon className="w-5 h-5" />
          <span className="text-base font-normal font-roboto-condensed flex-1 text-left">Search dish</span>
