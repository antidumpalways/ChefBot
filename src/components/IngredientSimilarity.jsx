    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-base-100 rounded-lg shadow-lg p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-2xl font-bold text-base-content font-dm-serif-display">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          <div>
            <label htmlFor="ingredients" className="block text-sm font-medium text-base-content mb-2 font-roboto-condensed">
              Ingredients
            </label>
            <textarea
              id="ingredients"
          ...
          <div>
            <label htmlFor="action" className="block text-sm font-medium text-base-content mb-2 font-inter">
              Analysis Type
            </label>
            <select
              id="action"
        ...
        {results && (
          <div className="space-y-6">
            <div className="bg-base-200 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-base-content mb-2 font-dm-serif-display">
                Base Ingredients
              </h3>
            ...
            {results.complementary && results.complementary.length > 0 && (
              <div className="bg-green-50 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-green-900 mb-2 font-dm-serif-display">
                  Complementary Ingredients
                </h3>
                <div className="space-y-2">
                  {results.complementary.map((item, index) => (
                    <div key={index} className="flex justify-between items-center">
                      <span className="text-green-800 font-medium font-roboto-condensed">{item.ingredient}</span>
            ...
            {results.substitutes && results.substitutes.length > 0 && (
              <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-blue-900 mb-2 font-dm-serif-display">
                  Substitute Ingredients
                </h3>
                <div className="space-y-2">
                  {results.substitutes.map((item, index) => (
                    <div key={index} className="flex justify-between items-center">
                      <span className="text-blue-800 font-medium font-roboto-condensed">{item.ingredient}</span>
            ...
            {results.reasoning && (
              <div className="bg-yellow-50 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-yellow-900 mb-2 font-dm-serif-display">
                  AI Reasoning
                </h3>
